...
export default function Projects() {
  return (
    <section className="w-full rounded-t-[20px]">
      ...
      <div className="w-full flex justify-center padding-x pt-[50px] pb-[120px]">
        <div className="flex items-center justify-between bg-secondry cursor-pointer rounded-full group relative z-40">
          <RoundButton
            href="https://ui.soralabs.io.vn/"
            title="explore sora ui"
            bgcolor="#000"
