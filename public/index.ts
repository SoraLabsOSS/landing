...
export { default as ourApproach } from "./our-approach.jpg";
...
export { default as heroSide } from "./hero-side.jpg";
export { default as eyeplay } from "./eyeplay.svg";
export { default as contactHero } from "./contacthhero.jpg";

// Soralabs (from apps/web)
export { default as handLeft } from "./hand-left.jpg";
export { default as handRight } from "./hand-right.jpg";
export { default as soraMark } from "./sora-mark.png";
export { default as soraUi } from "./projects/sora-ui.png";
export { default as soraType } from "./projects/sora-type.png";
export { default as soraLattice } from "./projects/sora-lattice.jpg";
